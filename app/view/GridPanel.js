...
Ext.define('App.view.GridPanel', {
    ...
    buildColumns:function(){ // creamos las columnas de nuestro grid
        var cols = [
            {text: 'Rendering engine', flex: 1, sortable: true, dataIndex: 'rendering_engine',editor: {
                xtype: 'textfield',
                allowBlank: false
            }},
            {text: 'Browser',          flex: 1, sortable: true,  dataIndex: 'browser',editor: {
                xtype: 'textfield',
                allowBlank: false
            }},
            {text: 'Platform(s)',      flex: 1, sortable: true,  dataIndex: 'platform',editor: {
                xtype: 'textfield',
                allowBlank: false
            }},
            {text: 'Engine version',   flex: 1, sortable: true,  dataIndex: 'engine_version',editor: {
                xtype: 'textfield',
                allowBlank: false
            }},
            {text: 'CSS Grade',        flex: 1, sortable: true,  dataIndex: 'css_grade',editor: {
                xtype: 'textfield',
                allowBlank: false
            }}
        ];
